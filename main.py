...
async def _list_tools() -> List[types.Tool]:
    ...
    return [
        types.Tool(
            name="say_hello",
            title="Say Hello",
            description="Generates a friendly hello world greeting with optional personalization",
            inputSchema={
                "type": "object",
                "properties": {
                    "name": {
                    ...
                    "language": {
                        "type": "string",
                        "description": "Language for the greeting (english, spanish, french, german, japanese)",
...
async def _call_tool_request(
    ...
    if tool_name == "say_hello":
        ...
        data = {
            ...
            "timestamp": "now",
            "allGreetings": [
                {"language": lang, "text": greetings[lang]}
        ...
        return types.CallToolResult(
            content=[
                types.TextContent(
                    type="text",
                    text=f"{greeting} This is a simple hello world greeting. See the interactive component below for more options.",
                )
            ],
            structuredContent={
                "greeting": greeting,
